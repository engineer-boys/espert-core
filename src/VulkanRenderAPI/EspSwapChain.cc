...
namespace esp
{
      ...
      m_window_extent{ window_extent }, m_old_swap_chain{ previous }
  {
    ...
    m_old_swap_chain =
        nullptr; // cleanup old swap chain since it's no longer needed
  }
  ...
  VkResult EspSwapChain::submit_command_buffers(const VkCommandBuffer* buffers,
  ...
  void EspSwapChain::create_swap_chain()
  {
    SwapChainSupportDetails swap_chain_support =
        m_device.get_swap_chain_support();

    VkSurfaceFormatKHR surface_format =
        choose_swap_chain_surface_format(swap_chain_support.m_formats);
    VkPresentModeKHR present_mode =
        choose_swap_chain_present_mode(swap_chain_support.m_present_modes);
    VkExtent2D extent =
        choose_swap_chain_extent(swap_chain_support.m_capabilities);
    ...
    uint32_t queue_family_indices[] = { indices.m_graphics_family,
  ...
  VkExtent2D EspSwapChain::choose_swap_chain_extent(
