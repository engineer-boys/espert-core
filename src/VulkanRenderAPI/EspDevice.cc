...
// class member functions
	...
	{
		// create_instance - initializes vulkan library, it's connection between our application and vulkan
		create_instance();
		// setup_debug_messenger - enables validation layers for debugging
		setup_debug_messenger();
		// create_surface - connection between our GLFWwindow and vulkan's ability do display results
		create_surface();
		// pick_physical_device - selects graphics device in our system which our application will be using
		pick_physical_device();
		// create_logical_device - describes what features of our physical device we want to use
	...
	VkFormat EspDevice::find_supported_format(
	...
	void EspDevice::copy_buffer_to_image(
	...
	void EspDevice::create_image_with_info(
